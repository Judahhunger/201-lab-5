...
var twomultiply = a * b;
var message = 'The product of ' + a + ' and ' + b + ' is ' + twomultiply + '.';
return [twomultiply, message];
}
...
var threeMultiply = multiply(a, multiply(b,c)[0])[0];
var thirdElement = a + ' and ' + b + ' and ' + c + ' sum to ' + sumOfThree + '.';
var fourthElement = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + threeMultiply + '.';
return [sumOfThree, threeMultiply, thirdElement, fourthElement];
}
...
//   var sumOfTestArray = 0; for(var i = 0; i < testArray.length; sum(i,i)[0]){
...
// Once you get the test pa,ssing, do an a-c-p cycle and synchronize the code between GitHub and your laptop. You're done! Submit the link to the repo following the instructions in Canvas.
